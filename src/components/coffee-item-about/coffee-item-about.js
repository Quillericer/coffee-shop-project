...
class CoffeeItemAbout extends Component {
    ...
    render() {
        const {region, price} = this.props.data;
        return(
            <section className="coffee">
                <div className="container">
                    <Link to="/our-coffee" className="go-back">Go back</Link>
                    <div className="coffee__info">
                        ...
                        <div className="coffee__info-text">
                            ...
                            <Divider/>
                            <div className="coffee__info-region"><span>Country:</span> {region}</div>
                            ...
                            <div className="coffee__info-price"><span>Price:</span> {price}</div>
                        </div>
                    </div>
                </div>
            </section>
